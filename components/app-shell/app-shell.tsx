...
export function AppShell({ children, initialUserInfo }: AppShellProps) {
  ...
  return (
    ...
    <div className="fixed inset-0 h-dvh w-screen bg-[#090E1A] dark:bg-slate-100 transition-colors flex overflow-hidden">
      ...
      <div className="flex-1 h-full flex flex-col min-w-0 overflow-hidden md:py-1.5 transition-all duration-300 ease-in-out md:pr-0">
        <div className="flex-1 h-full flex flex-col min-h-0 rounded-none md:rounded-l-[16px] md:rounded-r-none bg-slate-50 text-slate-900 dark:bg-[#0A0F1D] dark:text-slate-100 shadow-2xl overflow-hidden md:border-l-4 border-blue-500 dark:border-blue-300/60 md:border-r-0 transition-all duration-300 ease-in-out">
